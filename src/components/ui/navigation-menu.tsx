...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        "group/navigation-menu relative flex flex-row-reverse md:flex-row w-full flex-1 items-center  justify-between md:absolute p-4",
        className
      )}
      {...props}
    >
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        "group flex flex-col md:flex-row flex-1 list-none items-start md:items-center justify-center gap-1",
        className
      )}
      {...props}
    />
